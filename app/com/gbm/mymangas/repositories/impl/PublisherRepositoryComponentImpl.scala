 ...
 */
trait PublisherRepositoryComponentImpl extends PublisherRepositoryComponent {

  override def publisherRepository: PublisherRepository = new PublisherRepositoryImpl
