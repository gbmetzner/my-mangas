...
class PublisherController @Inject()(val messagesApi: MessagesApi,
  ...
  /**
    ...
    */
  def createPublisher: Action[JsValue] = hasTokenAsync(parse.json) { _ =>
    _ =>
      request =>
  ...
  def editPublisher(id: UUID): Action[AnyContent] = hasTokenAsync() { _ =>
    _ =>
      request =>
  ...
  def updatePublisher(id: UUID): Action[JsValue] = hasTokenAsync(parse.json) { _ =>
    _ =>
      request =>
  ...
  def removePublisher(id: UUID): Action[AnyContent] = hasTokenAsync() { _ =>
    _ =>
      request =>
